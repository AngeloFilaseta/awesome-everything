...
#### IDE
[PHPStorm](https://www.jetbrains.com/phpstorm/)(💲): JetBrains IDE for PHP development. ⭐⭐⭐⭐⭐   
<br/><br/><br/>
## Javascript
[npm](https://www.npmjs.com/get-npm): npm makes it easy for JavaScript developers to share and reuse code, and makes it easy to update the code that you’re sharing, so you can build amazing things.  
#### Libraries & Frameworks
...
[Overleaf](https://overleaf.com)(🌎): LaTeX online editor.  
[UpMath](https://upmath.me/)(🌎): Markdown and Latex online editor.
[Any other text editor](): Refer to [Multi-Purpose IDE/Text Editor](#multiPurposeIDE).
<br/><br/><br/>
## Markdown
#### IDE
[Remarkable](https://remarkableapp.github.io/): The best markdown editor for linux and Windows.  
[UpMath](https://upmath.me/)(🌎): Markdown and Latex online editor.  
[Any other text editor](): Refer to [Multi-Purpose IDE/Text Editor](#multiPurposeIDE).
#### Cheats
